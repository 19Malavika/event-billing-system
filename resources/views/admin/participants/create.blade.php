                ...
                <form action="{{ route('participants.store') }}" method="POST" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" name="course_department" id="course_department" value="{{ old('course_department') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required>
                        </div>
                        <div>
                    ...
                    <div class="flex justify-end space-x-3">
                        ...
                        <button type="submit" class="bg-indigo-600 text-white px-4 py-2 rounded-md text-sm hover:bg-indigo-700">Save Participant</button>
                    </div>
                </form>
            </div>
        </div>
